...
import { Info, Users, Target, Heart, Globe, Lightbulb, Award, Zap } from 'lucide-react';
  ...
  const teamMembers = [
    {
      ...
      description: "Especialista en sostenibilidad y análisis de huella de carbono",
      icon: "🌱"
    },
    {
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-4xl mx-auto leading-relaxed">
              ...
              <span className="text-emerald-600 font-semibold"> futuro más sostenible</span> a través de la tecnología y la conciencia ambiental.
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 mb-16">
          ...
          >
            <p className="text-lg mb-4">
              Empoderar a las personas para que tomen decisiones informadas sobre su impacto ambiental.
            </p>
            <p className="text-emerald-100">
              Proporcionamos herramientas accesibles y precisas para medir, entender y reducir la huella de carbono personal, 
              creando conciencia y promoviendo acciones concretas hacia un futuro más sostenible.
            </p>
          </Card>
          ...
          >
            <p className="text-lg mb-4">
              Un mundo donde cada persona contribuye activamente a la sostenibilidad ambiental.
            </p>
            <p className="text-teal-100">
              Visualizamos un futuro donde la medición y reducción de la huella de carbono sea parte natural de la vida cotidiana, 
              y donde las decisiones individuales generen un impacto colectivo positivo para nuestro planeta.
            </p>
          </Card>
        </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">¿Qué nos hace diferentes?</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Nuestra plataforma combina precisión científica con facilidad de uso
            </p>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Conoce a Nuestro Equipo</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                <div className="text-center">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-gray-800 mb-2">Nuestro Impacto</h2>
            <p className="text-gray-600">Juntos estamos haciendo la diferencia</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-700">Metas de sostenibilidad alcanzadas</p>
            </div>
            <div className="text-center">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-lg mb-6 text-emerald-100">
              Estamos aquí para ayudarte en tu camino hacia un estilo de vida más sostenible
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <div className="flex items-center bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full">
                <span className="mr-2">📧</span>
                <span>contacto@huelladecarbono.com</span>
              </div>
              <div className="flex items-center bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full">
                <span className="mr-2">🌐</span>
                <span>www.huelladecarbono.com</span>
              </div>
            </div>
          </div>
        </div>
